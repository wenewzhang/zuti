...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(apis::users::get_login_setting)
            .service(apis::users::post_login_setting)
            ...
            .service(apis::samba::update_public_share)
            ...
            .service(apis::docker::docker_start_container)
            ...
            .service(apis::docker::list_container_notes)
            .service(apis::docker::get_container_note)
            .service(apis::docker::delete_container_note)
            ...
            .service(apis::loger::get_zuti_log)
            .service(apis::loger::get_zuti_helper_log)
            .service(apis::loger::get_zuti_updater_log)
            ...
            .service(apis::system::get_services_status)
